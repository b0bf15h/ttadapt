...
def create_imagenetc_dataset(
    ...
    corruptions_seq = corruptions_seq if "mixed_domains" in setting else [corruption]
    data_dir = os.path.join(os.getcwd(),'data/ImageNet-C')
    ...
    if "mixed_domains" in setting or "correlated" in setting or n_examples != -1:
        ...
        path_to_json = '/home/bob/test-time-adaptation/classification/robustbench/data/imagenet_class_to_id_map.json'
        ...
        path_to_txt = '/home/bob/test-time-adaptation/classification/robustbench/data/imagenet_test_image_ids.txt'
