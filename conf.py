...
# Output directory
_C.SAVE_DIR = "./output/experiments/final/newmethods"
#_C.SAVE_DIR = "./output/mixed_domains_correlated/cifar10c/xcit/extensive"
...
_C.MODEL.WEIGHTS = "IMAGENET1K_V2"

# Path to a specific checkpoint
_C.MODEL.CKPT_PATH = './ckpt/cifar10/Standard/ckpt.pth'
